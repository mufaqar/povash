...
use POVASH\Includes\Classes\Header_Enqueue;
use POVASH\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['povash_base'] ) ) {
			return $GLOBALS['povash_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'povash' . '_options-mods' );

		$dn = povash_dot( $options );
