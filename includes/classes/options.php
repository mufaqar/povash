...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'povash' . '_options';
	...
	private $page_slug = 'povash' . '_options';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'POVASH Options', 'povash' );
		$this->page_title = esc_html__( 'POVASH Options', 'povash' );
	...
	function args() {
		...
		$args = array(
			...
			'global_variable'      => 'povash_options',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'povash' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'povash' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'povash' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'povash' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'povash' ) . '</p>';
...
'product_setting',
		...
		$sections_path = apply_filters( 'povash_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "povash_redux_sections_{$key}", $options );
