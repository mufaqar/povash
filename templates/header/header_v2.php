                    ...
                    <div class="upper-inner clearfix">
                        ...
                        <div class="upper-info pull-right">
                              <ul class="info-list clearfix"> 
                               <?php if(wp_kses( $options->get( 'email_v1'), $allowed_html )) : ?>	   
                                <li>
								    ...
								    <?php endif ; ?>
								<?php if(wp_kses( $options->get( 'phone_v1'), $allowed_html )) : ?>	    
								<li>
								    ...
								    <?php endif ; ?>
							<?php if(wp_kses( $options->get( 'address_v1'), $allowed_html )) : ?>	  
								 <li>
                ...
                <div class="auto-container">
                    <div class="lower-inner">
                        <div class="outer-box clearfix">
							...
							<?php if(wp_kses( $options->get( 'quote_v1'), $allowed_html )) : ?>	  	
